...
//
//cv::Rect
//validROIL;  // 图像校正之后，会对图像进行裁剪，这里的validROI就是指裁剪之后的区域
//cv::Rect validROIR;
//
...
//		disp, xyz, Q,
//		true);  // 在实际求距离时，ReprojectTo3D出来的X / W, Y / W, Z /
...
//	// stereo_match);
//
//	// 鼠标响应函数setMouseCallback(窗口名称, 鼠标回调函数,
//	// 传给回调函数的参数，一般取0)
