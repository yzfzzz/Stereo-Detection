...
Int8EntropyCalibrator2::Int8EntropyCalibrator2(int batch_size, int input_w,
                                               int input_h, const char *img_dir,
                                               const char *calib_table_name,
                                               bool read_cache)
    : batch_size_(batch_size), input_w_(input_w), input_h_(input_h),
      img_idx_(0), img_dir_(img_dir), calib_table_name_(calib_table_name),
...
bool Int8EntropyCalibrator2::getBatch(void *bindings[], const char *names[],
  ...
  cudaMemcpy(device_input_, batch_data, input_count_ * sizeof(float),
...
void Int8EntropyCalibrator2::writeCalibrationCache(const void *cache,
  ...
  std::cout << "writing calib cache: " << calib_table_name_
