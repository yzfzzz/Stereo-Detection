...
# 2 加载视频文件
det = Detector(model_path=b"D:\GDEE\Project\Release\yolov5.engine",dll_path="D:\GDEE\Project\Release\yolov5.dll")  # b'' is needed
...
while ret:
    ...
    # STEREO_SGBM_MODE_SGBM_3WAY / STEREO_SGBM_MODE_HH / STEREO_SGBM_MODE_SGBM / STEREO_SGBM_MODE_HH4
    ...
    # frame1 = resize_image(frame1, (320, 256))
